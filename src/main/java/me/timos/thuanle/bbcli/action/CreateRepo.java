...
public class CreateRepo extends BaseBatchAction implements Action {
    ...
    public static final String HAS_ISSUES_TRUE = "true";
    ...
    protected void performSingleAction(Map<String, String> params) throws IOException {
        ...
        String hasIssues = params.getOrDefault(FIELD_HAS_ISSUES, HAS_ISSUES_FALSE);

        System.out.format("%s: {repo: %s, scm: %s, isPrivate: %s}\n",
                ACTION_STRING, repoId, scm, isPrivate);

        OkHttpClient client = new OkHttpClient();
        Request request = ApiRequestCreator.requestCreateRepository(author, mCredential, repoId, scm, isPrivate, hasIssues);
